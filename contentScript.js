...
function evaluateItems(json) {
	...
	if (overallPercent >= 1 && overallPercent <= 40) {
		...
		badge = '<img src="' + bronze_badge +'" title="'+tip+'" alt="badge" width="95" height="100">';
		...
		//tip = "Guidelines: Correct " + nextBadge.toFixed(0) + "% UI recommendations to get your next badge!";
		badge = '<img src="' + silver_badge +'" title="'+tip+'" alt="badge" width="100" height="110">';
		...
		//tip = "Guidelines: Correct " + nextBadge.toFixed(0) + "% UI recommendations to get your next badge!";
		badge = '<img src="' + gold_badge +'" title="'+tip+'" alt="badge" width="80" height="100">';
		...
		badge =  '<img src="' + platinum_badge +'" alt="badge" width="90" height="110">';
	...
	var tip =  '<img src="'+tip_image+'" title="'+recommendations+'" alt="i" style="vertical-align: bottom;padding-left: 7px;">'
